...
<head>
    ...
    <meta name="viewport" content="width=790px, initial-scale=1, shrink-to-fit=no">
	...
	<!-- <link id="pagestyle" rel="stylesheet" type="text/css" href="<?= base_url('assets/css/own.css') ?>"> -->
		...
		<div class="page-header section-height-75">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<!-- <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8 m-100">
						...
						<div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8 m-100" style="max: height 9px;920px; background-image:url('<?= base_url(); ?>assets/img/curved6.jpg')">
